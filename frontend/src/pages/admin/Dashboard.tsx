...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Row 1: Cash, Bank, Liabilities, Receivables */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <GradientStatCard label="Liabilities" value={v(stats?.total_liabilities)} sub="What you owe" gradient="coral" icon={<ArrowUpRight className="h-5 w-5" />} />
        <GradientStatCard label="Receivables" value={v(stats?.total_receivables)} sub="What clients owe" gradient="emerald" icon={<ArrowDownLeft className="h-5 w-5" />} />
      </div>
      ...
      {/* Row 2: Revenue, Invoices, Active Jobs */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
